...
const menuData: MenuCategory[] = [
  {
    ...
    startingPrice: '$7.99',
    items: [
      { name: 'Double Cheesy', description: 'Doble carne smash de 80g, doble queso y cebolla grillada', price: '$7.99' },
      { name: 'Chicken Mayo', description: 'Pollo frito, lechuga, mayonesa, queso facilista y tocineta', price: '$7.99' },
      { name: 'Thousand Cheesy', description: 'Doble carne smash de 80g, queso facilista y salsa thousand island', price: '$8.50' },
      { name: 'Chicken Crunch', description: 'Pollo ultra crujiente con cheddar, tocineta y tártara', price: '$8.99' },
      { name: 'Chicken Spicy', description: 'Pollo frito picante de la casa con cheddar y tocineta ahumada', price: '$8.99' },
      { name: 'Shrimp Crunch', description: 'Langostinos rebozados con reducción de balsámico y tártara', price: '$8.99' },
      { name: 'Clásica Americana', description: '150g de solomo con cheddar, tocineta, pepinillos y mayonesa', price: '$9.99' },
      { name: 'Honeyholic Burger', description: 'Pollo crispy con miel y cholula, cheddar, manchego y tocineta', price: '$9.99' },
      { name: 'Texmex', description: '150g de solomo con jalapeños, cheddar y cebolla caramelizada', price: '$9.99' },
      { name: 'Onion Queen', description: '150g de carne con cebolla crunch, cheddar y salsa tártara', price: '$9.99' },
      { name: 'BBQ Champions', description: '150g de solomo en salsa BBQ de la casa con queso azul', price: '$10.50' },
      { name: 'Smash', description: 'Doble carne smash 300g con cheddar, tocineta y pepinillos', price: '$13.99' },
      { name: 'Thousand Smash', description: 'Triple carne smash 300g con thousand island y cheddar', price: '$13.99' },
    ],
  },
  {
    title: 'Emparedados',
    startingPrice: '$8.99',
    items: [
      { name: 'Chicken Crunch Americano', description: 'Pollo empanizado dorado con cheddar, tocineta y tártara', price: '$8.99' },
      { name: 'Perla Negra', description: 'Calamares rebozados con vegetales frescos y tártara', price: '$8.99' },
      { name: 'Chicken Cesar', description: 'Pollo crispy con aderezo césar, manchego y tocineta', price: '$9.50' },
      { name: 'Fondue de Lomito', description: 'Lomito tierno en fondue de queso azul con champiñones', price: '$11.99' },
    ],
  },
  {
    title: 'Pizzas',
  ...
  },
  {
    ...
    startingPrice: '$10.99',
    items: [
      { name: 'Parrilla Mixta', description: 'Cortes de carne y pollo asados al punto', price: '$10.99' },
      { name: 'Parrilla de Pollo', description: 'Pechuga marinada asada a la parrilla', price: '$10.99' },
      { name: 'Parrilla de Lomito', description: 'Corte de lomito asado conservando todos sus jugos', price: '$11.99' },
      { name: 'Parrilla Mar y Tierra', description: 'Selección de carnes rojas y mariscos frescos a la parrilla', price: '$15.50' },
      { name: 'Parrilla de Mariscos', description: 'Selección premium de frutos del mar asados', price: '$15.50' },
    ],
  },
  {
    title: 'Ensaladas',
