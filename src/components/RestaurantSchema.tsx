  ...
  const schema = {
    ...
    "mentions": [
      { "@type": "MenuItem", "name": "Honeyholic Burger",
        "description": "Pollo crispy con miel y cholula, $9.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "BBQ Champions",
        "description": "Solomo con salsa BBQ de la casa, $10.50 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Clásica Americana",
        "description": "150g solomo con tocineta y cheddar, $9.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Smash Burger",
        "description": "Doble carne smash 300g con cheddar, $13.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Thousand Smash",
        "description": "Triple carne smash 300g con thousand island, $13.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Double Cheesy",
        "description": "Doble smash con doble queso, $7.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Texmex Burger",
        "description": "Solomo con jalapeños y cebolla caramelizada, $9.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Onion Queen",
        "description": "150g carne con cebolla crunch y tártara, $9.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Chicken Crunch",
        "description": "Pollo crujiente con cheddar y tocineta, $8.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Chicken Spicy",
        "description": "Pollo frito picante con cheddar, $8.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Shrimp Crunch",
        "description": "Langostinos rebozados con balsámico, $8.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Thousand Cheesy",
        "description": "Doble smash 80g con thousand island, $8.50 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Chicken Mayo",
        "description": "Pollo frito con mayonesa y cheddar, $7.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Chicken Crunch Americano",
        "description": "Emparedado pollo empanizado con tártara, $8.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Perla Negra",
        "description": "Emparedado de calamares rebozados con tártara, $8.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Fondue de Lomito",
        "description": "Emparedado de lomito en fondue de queso azul, $11.99 USD. Catarsis Lechería" },
      { "@type": "MenuItem", "name": "Chicken Cesar",
        "description": "Emparedado pollo crispy con aderezo césar, $9.50 USD. Catarsis Lechería" },
