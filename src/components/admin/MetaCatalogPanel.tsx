              ...
              <div className="divide-y divide-border">
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-muted/20">
                  <div className="min-w-0 flex-1">
                    ...
                    {/* [2026-07-02] CATARSIS — Formato de URL de producto actualizado */}
                    <p className="text-xs text-muted-foreground font-mono">{BASE_URL}/<span className="italic text-primary">{'{categoria}'}</span>/<span className="italic text-primary">{'{slug}'}</span></p>
                  </div>
                </div>
              </div>
            </div>
