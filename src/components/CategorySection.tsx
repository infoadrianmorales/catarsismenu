      ...
      <div className="container px-4">
        ...
        {hasMore && (
          <div className="mt-6 flex justify-center">
            <Link
              to={`/categoria/${slug}`}
              className="group inline-flex items-center gap-2 rounded-full bg-[#FFB800] px-8 py-4 font-display font-black uppercase tracking-wide text-[#F2E9D8] shadow-lg transition-all hover:bg-[#FFB800]/90 hover:shadow-xl hover:-translate-y-0.5"
            >
